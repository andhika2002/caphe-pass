...
import { ShoppingCart, Clock, MapPin, CreditCard, Truck, AlertCircle } from "lucide-react"
...
export default function CheckoutPage() {
  ...
  // Mock cart data
  const cartItems = [
    { id: 1, name: "Vietnamese Iced Coffee", quantity: 2, price: 45000 },
    { id: 2, name: "Bánh Mì", quantity: 1, price: 35000 },
    { id: 3, name: "Croissant", quantity: 2, price: 40000 },
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="p-6 bg-card border-border">
                ...
                <div className="flex items-center gap-4">
                  <img
                    src="/modern-vietnamese-coffee-shop-interior.jpg"
                    alt="The Coffee House"
                    className="h-16 w-16 rounded-lg object-cover"
                  />
                  <div>
                    <div className="font-semibold text-card-foreground text-lg">The Coffee House</div>
                    <div className="text-sm text-muted-foreground">123 Nguyen Hue, District 1, HCMC</div>
                    <div className="text-sm text-green-500 font-medium mt-1">Open Now • 0.5 km away</div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 bg-card border-border">
                ...
                <div className="bg-background rounded-lg p-4 mb-4">
                  <div className="text-card-foreground font-medium">Today, 2:10 PM</div>
                  <div className="text-sm text-muted-foreground mt-1">Ready in approximately 10 minutes</div>
                </div>
            ...
            <div className="lg:col-span-1">
              <Card className="p-6 bg-card border-border sticky top-20">
                ...
                <Button className="w-full bg-accent text-accent-foreground hover:bg-accent/90 mb-3" asChild>
                  <Link href="/customer/pre-order/success">
                ...
                <p className="text-xs text-muted-foreground text-center">
                  Payment processed securely. You'll receive a pickup code via SMS.
                </p>
              </Card>
            </div>
          </div>
